...
namespace _03HandsOnActivity02
{
    ...
    public partial class frmAddProduct : Form
    {
        ...
        private void frmAddProduct_Load(object sender, EventArgs e)
        {
            string[] ListProductCategory = new String[]
                {
                    "Beverages","Bread/Bakery","Canned/JarredGoods","Dairy","Frozen Goods","Meat","Personal Care",
                    "Other"
                };
            foreach (String item in ListProductCategory) 
            {
        ...
        public int Quantity(string qty)
        {
            ...
            {
                throw new NumberFormatException("Enter valid Product Name");
            }
        ...
        public double SellingPrice(string price)
        {
            ...
            {
                throw new CurrencyFormatException("Enter a valid price");
            }
